...
class RecyclerItemTouchHelper(private val adapter: ToDoAdapter) :
    ...
    override fun onChildDraw(
        ...
        if (dX > 0) {
            todo = ContextCompat.getDrawable(adapter.getContext(), R.drawable.baseline_edit)
            ...
            todo = ContextCompat.getDrawable(adapter.getContext(), R.drawable.baseline_delete)
